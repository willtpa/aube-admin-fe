<script lang="ts">
    ...
    export let currencyRate: APIResponse<components['schemas']['MedianFxRateV1']>;
...
<div>
    <div class="flex px-1 py-1 font-thin">
        ...
        <button
            ...
            onclick={async () => {
                if (currencyRate.rate_base_quote) {
                    await navigator.clipboard.writeText(currencyRate.rate_base_quote);
                }
            }}
        >
