...
<fieldset class="border border-solid border-gray-300 p-2 w-fit">
	...
	<form method="GET" action="?/search">
		<div class="md:flex md:items-center mb-4">
			<div class="md:w-24">
				<label class="block font-bold md:text-right mb-1 md:mb-0 pr-4" for="networkCurrencyId">
					Currency
				</label>
			</div>
			<select
		...
		<div class="md:flex md:items-center mb-4">
			<div class="md:w-24">
				<label class="block font-bold md:text-right mb-1 md:mb-0 pr-4" for="fromDate"> From </label>
			</div>
			<div>
				<input
					id="fromDate"
		...
		<div class="md:flex md:items-center mb-4">
			<div class="md:w-24">
				<label class="block font-bold md:text-right mb-1 md:mb-0 pr-4" for="toDate"> To </label>
			</div>
			<div>
				<input id="toDate" name="toDate" type="datetime-local" bind:value={inputToDate} step="1" />
			</div>
		</div>
