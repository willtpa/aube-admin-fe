<script lang="ts">
    ...
    import {
        ...
        type CreateIndividualSchema,
        type UpdateIndividualSchema,
    } from './schemas';
    ...
    interface Props {
        data: SuperValidated<Infer<CreateIndividualSchema | UpdateIndividualSchema>>;
    }

    const { data }: Props = $props();

    const form = superForm(data, {
        validators: zodClient($page.params['id'] ? updateIndividualSchema : createIndividualSchema),
        resetForm: false,
