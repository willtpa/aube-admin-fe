<script lang="ts">
    ...
    import {
        ...
        type CreateCorporateRelatedPartySchema,
        updateCorporateRelatedPartySchema,
        type UpdateCorporateRelatedPartySchema,
    } from './schemas';
    import {
        countryOptions,
    ...
    interface Props {
        data: SuperValidated<
            Infer<CreateCorporateRelatedPartySchema | UpdateCorporateRelatedPartySchema>
        >;
    }
...
<form method="POST" action="?/corporate" use:enhance>
    <div class="grid grid-cols-2 gap-4">
        ...
        <ChipsInputField {form} name="former_registered_names" label="Former Registered Names" />
